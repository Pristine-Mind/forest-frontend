              ...
              <Table>
                <TableHeader>
                  <TableRow>
                    ...
                    <TableHead>{t("tableUpdatedAt")}</TableHead>
                ...
                <TableBody>
                  {data?.results.map((h) => (
                    <TableRow key={h.id}>
                      ...
                      <TableCell className="capitalize">{h.education_level}</TableCell>
                      <TableCell className="capitalize">{h.occupation}</TableCell>
                      <TableCell className="capitalize">{h.caste_ethnicity}</TableCell>
                      <TableCell>{formatDate(h.registration_date)}</TableCell>
                      <TableCell className="capitalize">{h.entry_fee_type}</TableCell>
                      <TableCell className="text-right">{h.entry_fee_due}</TableCell>
                      <TableCell className="capitalize">{h.status}</TableCell>
                      <TableCell>{formatDate(h.created_at)}</TableCell>
                      <TableCell>{formatDate(h.updated_at)}</TableCell>
                      <TableCell>
